...
namespace YTech.SIMK.WMTI.Data.NHibernateMaps.Transaction
{
    public class TInstallmentMap : IAutoMappingOverride<TInstallment>
    {
        ...
        public void Override(AutoMapping<TInstallment> mapping)
        {
            ...
            mapping.References(x => x.InstallmentNo, "INSTALLMENT_NO");
            mapping.References(x => x.InstallmentBasic, "INSTALLMENT_BASIC");
            mapping.References(x => x.InstallmentInterest, "INSTALLMENT_INTEREST");
            mapping.References(x => x.InstallmentOthers, "INSTALLMENT_OTHERS");
