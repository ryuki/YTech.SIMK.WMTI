...
<div id="formArea">
    <table>
        ...
        <tr>
            ...
            <td class="style11">&nbsp;</td>
            <td><input type="text" id="LoanTotal" style="font-size:x-large;" /></td>
        </tr>
        <tr>
            ...
            <td class="style11"><label for="LoanProfit" style="font-size:x-large;">LABA :</label></td>
            <td><input type="text" id="LoanProfit" style="font-size:x-large;" /></td>
        </tr>
        <tr>
            <td class="style7"><label for="LoanTenor" style="font-size:x-large;">ANGSURAN :</label></td>
            <td class="style8"><input type="text" id="LoanTenor" style="font-size:x-large; width:74px" /></td>
            <td>
                <table>
                    <tr>
                        <td class="style10">
            ...
            <td>
                <input type="text" id="TotalTenorMonth" style="font-size:x-large;" /></td>
        </tr>
        </table>
</div>
