...
<% } %>
<p class="title">Data Bulan <%= Model.CurrentLoanSummary.Month.ToString(CommonHelper.MonthFormat)%> </p>
...
<td>
Total PK = <%= CommonHelper.ConvertToString(Model.CurrentLoanSummary.TotalLoan)%> Permohonan
</td>
</tr>
<tr>
<td>
PK Terima = <%= CommonHelper.ConvertToString(Model.CurrentLoanSummary.TotalLoanApprove)%> Permohonan
</td>
</tr>
<tr>
<td>
PK Tolak = <%= CommonHelper.ConvertToString(Model.CurrentLoanSummary.TotalLoanReject)%> Permohonan
</td>
</tr>
<tr>
<td>
PK Tunda = <%= CommonHelper.ConvertToString(Model.CurrentLoanSummary.TotalLoanPostpone)%> Permohonan
</td>
</tr>
<tr>
<td>
PK Cancel = <%= CommonHelper.ConvertToString(Model.CurrentLoanSummary.TotalLoanCancel)%> Permohonan
</td>
</tr>
</table>
