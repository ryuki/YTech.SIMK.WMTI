...
namespace YTech.SIMK.WMTI.Web.CastleWindsor
{
    public class ComponentRegistrar
    {
        ...
        private static void AddApplicationServicesTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                .FromAssemblyNamed("YTech.SIMK.WMTI.ApplicationServices")
                .Pick()
        ...
        private static void AddCustomRepositoriesTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                .FromAssemblyNamed("YTech.SIMK.WMTI.Data")
                .Pick()
                .WithService.FirstNonGenericCoreInterface("YTech.SIMK.WMTI.Core"));
        }
